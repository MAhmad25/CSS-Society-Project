const IlluminatedHero = () => {
      return (
            <div className="relative w-full flex h-screen flex-wrap items-center justify-center overflow-hidden bg-black text-[calc(var(--size)*0.022)] text-white [--factor:min(1000px,100vh)] [--size:min(var(--factor),100vw)]">
                  <div className="text-center text-4xl w-[65%] md:text-6xl font-semibold" aria-hidden="true">
                        <span className="relative  inline-block before:absolute before:animate-[onloadopacity_1s_ease-out_forwards] before:opacity-0 before:content-[attr(data-text)] before:bg-[linear-linear(0deg,#dfe5ee_0%,#fffaf6_50%)] before:bg-clip-text before:text-[#fffaf6] filter-[url(#glow-4)]" data-text="Illuminated Glow Text.">
                              Computer Science Society
                        </span>
                        <br />
                        From Curiosity to Creativity That's the CSS Way.
                        <br />
                  </div>
