        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Meet the amazing CSS Members behind CSS Society
            </p>
          </div>
          {isAdmin && (
            <button
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-200">
            ...
            <form onSubmit={handleCreateMember} className="space-y-6">
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="px-6 py-2 bg-linear-to-r from-blue-900 to-blue-700 text-white rounded-lg hover:shadow-lg font-medium"
                >
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {activemembers.map((member) => (
              <div
                key={member._id}
                className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition overflow-hidden border border-gray-200"
              >
                {/* Header */}
                <div className="h-24 bg-linear-to-r from-blue-500 to-blue-700 flex items-end justify-center pb-4">
                  <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center border-4 border-blue-700 overflow-hidden">
                    {member.image ? (
                      <img
                        src={member.image}
                        alt={member.name}
                  ...
                  <div className="flex justify-center gap-3 mb-6">
                    ...
                    {member.socialLinks?.twitter && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2 bg-gray-100 text-blue-400 rounded-full hover:bg-blue-50"
                      >
                        <Twitter size={18} />
                      </a>
                    )}
                    ...
                    {isAdmin && (
                      <>
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-amber-100 text-amber-700 rounded-lg hover:bg-amber-200 font-medium text-sm"
                        >
                          <Edit size={16} />
                          Edit
                        </button>
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-red-100 text-red-700 rounded-lg hover:bg-red-200 font-medium text-sm"
                        >
                          <Trash2 size={16} />
                          Delete
                        </button>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  {selectedMember.socialLinks?.twitter && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-400 rounded-lg hover:bg-blue-50"
                    >
