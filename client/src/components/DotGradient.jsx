...
function Scene() {
      ...
      return (
            <mesh scale={[scale, scale, 1]} onPointerMove={handlePointerMove}>
                  ...
                  <primitive object={dotMaterial} resolution={[size.width * viewport.dpr, size.height * viewport.dpr]} rotation={rotation} gridSize={gridSize} mouseTrail={trail} render={0} />
            </mesh>
      );
}
